          ...
          <div className="grid grid-cols-3 grid-rows-3 gap-8 w-full max-w-4xl aspect-square">
            ...
            <div className="col-start-1 col-span-1 row-start-1 row-span-1 flex items-start justify-start">
              ...
              {!isPanelOpen('habits') ? (
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 w-full min-w-[85vw] sm:min-w-0 sm:max-w-sm md:max-w-md max-h-[80vh] overflow-auto z-20 border-l-4 border-blue-500 origin-top-left">
            ...
            <div className="col-start-3 col-span-1 row-start-1 row-span-1 flex items-start justify-end">
              ...
              {!isPanelOpen('streaks') ? (
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 w-full min-w-[85vw] sm:min-w-0 sm:max-w-sm md:max-w-md max-h-[80vh] overflow-auto z-20 border-r-4 border-orange-500">
      ...
      <XPBar xp={xp} maxXp={maxXp} previewXp={previewXp} />
            ...
            <div className="col-start-1 col-span-1 row-start-3 row-span-1 flex items-end justify-start">
              ...
              {!isPanelOpen('records') ? (
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 w-full min-w-[85vw] sm:min-w-0 sm:max-w-sm md:max-w-md max-h-[80vh] overflow-auto z-20 border-l-4 border-purple-500 origin-bottom-left">
            ...
            <div className="col-start-3 col-span-1 row-start-3 row-span-1 flex items-end justify-end">
              ...
              {!isPanelOpen('todos') ? (
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 w-full min-w-[85vw] sm:min-w-0 sm:max-w-sm md:max-w-md max-h-[80vh] overflow-auto z-20 border-r-4 border-green-500 origin-bottom-right">
